...
import com.ruderu.arttracker.integration.model.kin.KinSearchModel;
...
public class FilmApi {
    ...
    public List<KinResultModel> searchByKeyword(String keyword, List<String> type) {
        ...
        System.out.println(kinSearchModel);
        ...
        if (pageCount == 0) resultModels.addAll(
                Arrays.asList(
                        kinSearchModel.getKinResultModels()
                )
        );
